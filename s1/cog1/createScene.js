...
function(exports, scenegraph, animation) {
	...
	function init() {
		...
		var arm = scenegraph.createNodeWithModel("arm", "bar", {scale:30});
		var hand = scenegraph.createNodeWithModel("hand", "cube", {scale:30}, arm);
		var finger1 = scenegraph.createNodeWithModel("finger1", "bar", {scale:15}, hand);
		var finger2 = scenegraph.createNodeWithModel("finger2", "bar", {scale:15}, hand);
		//cubeNode.rotateTo([1.6, -3.87, 0]);
// Translate
hand.translate([90,0,0]);
finger1.translate([45,20,0]);
finger2.translate([45,-20,0]);

...
function(exports, scenegraph, animation) {
	...
	function init() {
		...
		var sun = scenegraph.createNodeWithModel("sun", "mySphere", {scale:150});
		var earth = scenegraph.createNodeWithModel("earth", "mySphere", {scale:100}, sun);
		var moon = scenegraph.createNodeWithModel("moon", "mySphere", {scale:50}, earth);
		earth.translate([1500,0,0]);
		moon.translate([350,0,0]);
		
		// Animation
animation.assign(sun, "rotate", {rotationSpeed:[0,0.1,0]})
animation.assign(earth, "rotate", {rotationSpeed:[0,0.1,0]})
animation.assign(moon, "rotate", {rotationSpeed:[0,0.1,0]})

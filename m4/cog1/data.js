...
define(["exports", "data", "glMatrix"], function (data, exports) {
  ...
  //     if (doubleVectors[getKey(vertexToCheck)]) {
  ...
  //         if (
  //           !doubleVectors[getKey(vertexToCheck)] ||
  //           !doubleVectors[getKey(vertexToCheck)].found
  //         ) {
  //           var tmp = [];
  //           tmp.push(j);
  //           doubleVectors[getKey(vertexToCheck)] = {};
  //           doubleVectors[getKey(vertexToCheck)].original = i;
  //           doubleVectors[getKey(vertexToCheck)].found = tmp;
  //         } else {
  //           doubleVectors[getKey(vertexToCheck)].found.push(j);
  //         }
  //       }
  //     }
  //   }
  ...
  //     if (doublePolyVerticeIndices[getKey(vertexToCheck)]) {
  //       continue; 
  //     }
  //     //check starting from the next
  ...
  //       if (vectorsEqual(vertexToCheck, next)) {
  //         if (
  //           !doublePolyVerticeIndices[getKey(vertexToCheck)] ||
  //           !doublePolyVerticeIndices[getKey(vertexToCheck)].found
  //         ) {
  //           var tmp = [];
  //           tmp.push(j);
  //           doublePolyVerticeIndices[getKey(vertexToCheck)] = {};
  //           doublePolyVerticeIndices[getKey(vertexToCheck)].found = tmp;
  //         } else {
  //           doublePolyVerticeIndices[getKey(vertexToCheck)].found.push(j);
  //         }
  //       }
  //     }
  //   }
  ...
  //   });
  //   for (var i = indicesToDelete.length - 1; i >= 0; i--) {
  //     this.vertices.splice(indicesToDelete[i], 1);
  //   }
  ...
  function calcuateVertexNormalsFromPolygonNormals() {
    ...
    // Loop over polygons.
    this.polygonVertices.forEach((polygon, index) => {
      polygon.forEach((vertex) => {
        vec3.add(this.vertexNormals[vertex], this.polygonNormals[index]);
      });
    });
    this.vertexNormals.forEach((element) => vec3.normalize(element));
